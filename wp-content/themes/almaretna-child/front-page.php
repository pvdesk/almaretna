...
// Hero background
$hero_bg = get_theme_mod('almaretna_hero_bg', '');
if (!$hero_bg && !empty($rooms) && has_post_thumbnail($rooms[0]->ID)) {
    $hero_bg = get_the_post_thumbnail_url($rooms[0]->ID, 'full');
}
// Villa image
$villa_img = get_theme_mod('almaretna_villa_img', '');
if (!$villa_img && count($rooms) > 1 && has_post_thumbnail($rooms[1]->ID)) {
    $villa_img = get_the_post_thumbnail_url($rooms[1]->ID, 'large');
} elseif (!$villa_img && !empty($rooms) && has_post_thumbnail($rooms[0]->ID)) {
    $villa_img = get_the_post_thumbnail_url($rooms[0]->ID, 'large');
}

// Customizer text
$hero_title    = get_theme_mod('almaretna_hero_title', "Un rifugio\ndove l'Etna\ntocca il cielo");
$hero_subtitle = get_theme_mod('almaretna_hero_subtitle', 'Villa con piscina panoramica alle pendici del vulcano, tra agrumeti e silenzio');
?>
...
<section class="hero-premium" aria-label="Hero Almaretna">
    ...
    <div class="hero-premium__content">
        <p class="hero-premium__eyebrow" data-reveal="fade">
            Nunziata di Mascali &nbsp;·&nbsp; Etna · Sicilia
        </p>
        ...
        <div class="hero-premium__actions" data-reveal="up" data-delay="300">
            <a href="<?php echo esc_url($prenota_url); ?>" class="hero-premium__cta-primary">
                ...
                <?php esc_html_e('Prenota il tuo soggiorno', 'almaretna-child'); ?>
            </a>
    ...
    <a href="#booking-strip" class="hero-premium__scroll" aria-label="Scorri">
        <span class="hero-premium__scroll-label">Scorri</span>
...
<div class="booking-strip" id="booking-strip">
    <form class="booking-strip__inner" method="get" action="<?php echo esc_url($prenota_url); ?>">

        <div class="booking-strip__field">
            <span class="booking-strip__label">
            ...
            <input type="date" class="booking-strip__input" name="checkin" id="hb-checkin"
        ...
        <div class="booking-strip__field">
            ...
            <input type="date" class="booking-strip__input" name="checkout" id="hb-checkout"
        ...
        <div class="booking-strip__field">
            ...
            <select class="booking-strip__input" name="adults" style="-webkit-appearance:none;appearance:none">
        ...
        <button type="submit" class="booking-strip__btn">
...
<div class="amenities-bar" data-reveal="up">
    <div class="amenities-bar__grid">
        ...
        $amenities = [
            [
                'icon' => '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><path d="M2 12h20M2 17c1.5 0 3-1 3-2s1.5-2 3-2 3 1 3 2 1.5 2 3 2 3-1 3-2"/><circle cx="7" cy="7" r="2"/><path d="M7 9v3"/></svg>',
                'name' => 'Piscina panoramica',
                'sub'  => 'Vista sull\'Etna e sul mare',
            ],
            [
                'icon' => '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><polygon points="3 20 12 4 21 20"/><polyline points="3 20 8 13 12 16 16 11 21 20"/></svg>',
                'name' => 'Vista vulcano',
                'sub'  => 'A 20 min dall\'Etna',
            ],
            [
                'icon' => '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><path d="M17 8h1a4 4 0 010 8h-1"/><path d="M3 8h14v9a4 4 0 01-4 4H7a4 4 0 01-4-4z"/><line x1="6" y1="2" x2="6" y2="4"/><line x1="10" y1="2" x2="10" y2="4"/><line x1="14" y1="2" x2="14" y2="4"/></svg>',
                'name' => 'Colazione inclusa',
                'sub'  => 'Prodotti biologici locali',
            ],
            [
                'icon' => '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><path d="M5 12.55a11 11 0 0114.08 0"/><path d="M1.42 9a16 16 0 0121.16 0"/><path d="M8.53 16.11a6 6 0 016.95 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></svg>',
                'name' => 'Wi-Fi ultra-veloce',
                'sub'  => 'Fibra in tutta la villa',
            ],
            [
                'icon' => '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',
                'name' => 'Pagamento sicuro',
                'sub'  => 'Stripe · SSL certificato',
            ],
        ];
...
<section class="experience-section">
    ...
    <div class="experience-section__inner">
        ...
        <blockquote class="experience-section__quote" data-reveal="up" data-delay="100">
            "Qui il tempo non si misura in ore,<br>
            ma in profumi di zagara, in tramonti sull'Etna<br>
            e in colazioni che non finiresti mai."
        </blockquote>
        <p class="experience-section__author" data-reveal="up" data-delay="200">
            — Un ospite di Almaretna
        </p>
...
<section class="rooms-section" id="section-camere">
    <div style="max-width:1260px;margin:0 auto;padding-inline:2rem;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-end;flex-wrap:wrap;gap:1rem;margin-bottom:2.5rem;">
            <div data-reveal="up">
                <span class="section-eyebrow">Dove soggiornare</span>
                <h2 class="section-headline">Le nostre <em>camere</em></h2>
            </div>
    ...
    <div class="story-section__grid">
        ...
        <div class="story-section__images" data-reveal="left">
            ...
            <div class="story-section__badge">
                ...
                <span class="story-section__badge-label">Ospitalità</span>
            </div>

            <?php
            // Seconda immagine se disponibile
            if (count($rooms) > 1 && has_post_thumbnail($rooms[1]->ID)) :
        ...
        <div data-reveal="right">
            ...
            <h2 class="section-headline">Un angolo di<br><em>Sicilia autentica</em></h2>
            <span class="divider-line"></span>

            <div class="story-section__text">
                <p><?php echo esc_html(get_theme_mod('almaretna_villa_text_1', "Almaretna è una villa di charme immersa negli agrumeti alle pendici dell'Etna, nel suggestivo borgo di Nunziata di Mascali. Qui il tempo rallenta, i profumi di zagara riempiono l'aria e la vista sul vulcano ti lascia senza parole.")); ?></p>
                <p><?php echo esc_html(get_theme_mod('almaretna_villa_text_2', "Ogni camera è curata nei dettagli per offrirti il massimo del comfort, mentre la nostra piscina panoramica diventa il punto di incontro perfetto tra cielo, Etna e mare.")); ?></p>
            </div>
            ...
            <ul class="story-section__checklist">
                ...
                $checks = [
                    ...
                    'Colazione con prodotti biologici locali ogni mattina',
...
<?php
$pool_img  = get_theme_mod('almaretna_pool_img',  '');
$pool_img2 = get_theme_mod('almaretna_pool_img2', '');
?>
...
<div class="pool-section__badge">
                ...
                <span class="pool-section__badge-label">Lunghezza piscina</span>
            </div>
<?php if ($pool_img2) : ?>
...
<div data-reveal="right">
            <span class="section-eyebrow">La nostra piscina</span>
            <h2 class="section-headline">Un tuffo<br>nel <em>cuore dell'Etna</em></h2>
            <span class="divider-line"></span>

            <p style="font-size:1.05rem;color:#6B6058;line-height:1.9;margin-bottom:1.25rem;">
                La piscina di Almaretna è uno spazio pensato per il vero relax: <strong>12 metri per 5 di larghezza</strong>, con una profondità che arriva fino a <strong>3,5 metri</strong>. Immersa nel silenzio degli agrumeti con vista sull'Etna, è il luogo perfetto per una nuotata rigenerante o per oziare al sole.
            </p>
<div class="pool-specs">
                <div class="pool-spec">
                    ...
                    <div>
                        ...
                        <span class="pool-spec__label">Superficie nuoto</span>
                    </div>
                </div>
                <div class="pool-spec">
                    <svg width="20" height="20" fill="none" stroke="#C5B49C" stroke-width="1.8" viewBox="0 0 24 24"><path d="M12 2v20M2 7h20M2 17h20"/></svg>
                    <div>
                        <span class="pool-spec__val">fino a 3,5 m</span>
                        <span class="pool-spec__label">Profondità massima</span>
                    </div>
                </div>
            </div>
<div class="pool-bar">
                <div class="pool-bar__header">
                    ...
                    <h3 class="pool-bar__title">Bar a bordo piscina</h3>
                </div>
                <p class="pool-bar__desc">A disposizione degli ospiti, il locale bar è attrezzato per ogni esigenza:</p>
                <ul class="pool-bar__list">
                    <?php
                    $dotazioni = [
                        'Lavello e piano di appoggio',
                        '2 servizi igienici dedicati',
                        'Punto cottura',
                        'Forno elettrico',
...
<div class="gallery-strip">
    ...
    // 2. Fallback: immagini dalle camere CPT se il Customizer è vuoto
    if (empty($gallery_imgs)) {
        foreach ($rooms as $r) {
            if (has_post_thumbnail($r->ID)) {
                $gallery_imgs[] = get_the_post_thumbnail_url($r->ID, 'large');
            }
            $gallery_ids = get_post_meta($r->ID, '_room_gallery', true);
...
<section class="testimonials-section">
    <div style="max-width:1200px;margin:0 auto;">
        <div style="text-align:center;" data-reveal="up">
            <span class="section-eyebrow" style="justify-content:center;">Cosa dicono i nostri ospiti</span>
            <h2 class="section-headline">Storie di <em>chi c'era</em></h2>
        </div>
        ...
        <div class="testimonials-grid">
            ...
            $reviews = [
                [
                    'text'   => 'Un posto fuori dal tempo. La piscina con vista sull\'Etna al tramonto è qualcosa che non dimenticherò mai. La colazione siciliana è stata una scoperta ogni giorno.',
                    'name'   => 'Martina B.',
                    'origin' => 'Milano',
                    'init'   => 'M',
                    'stars'  => 5,
                ...
                [
                    'text'   => 'Almaretna è esattamente quello che cercavamo: pace, natura autentica, ospitalità vera. Siamo rimasti una settimana e torneremo sicuramente. La camera era curatissima.',
                    'name'   => 'François & Sophie',
                    'origin' => 'Parigi, Francia',
                    'init'   => 'F',
                    'stars'  => 5,
                ],
                [
                    'text'   => 'La posizione è imbattibile: il mare a 10 minuti, l\'Etna praticamente in casa. La struttura è pulita, elegante e gli host sono disponibilissimi. Consiglio vivamente.',
                    'name'   => 'Roberto C.',
                    'origin' => 'Roma',
                    'init'   => 'R',
                    'stars'  => 5,
        ...
        <div class="testimonials-cta" data-reveal="up">
            ...
            <div class="testimonials-rating">
                ...
                <strong>4.9 / 5</strong>
                <span style="color:#8C8070;">su Google &amp; Booking.com</span>
            </div>
        </div>
    </div>
</section>
...
<section class="location-premium">
    <div class="location-premium__grid">
        ...
        <div data-reveal="left">
            <span class="section-eyebrow">Come raggiungerci</span>
            <h2 class="section-headline">Nel cuore<br>della <em>Sicilia</em></h2>
            <span class="divider-line"></span>
            ...
            <ul class="distance-list">
                <?php
                $distances = [
                    ['✈️', 'Aeroporto di Catania', '30 min'],
                    ['🌊', 'Spiagge di Fondachello', '10 min'],
                    ['🏛️', 'Taormina', '25 min'],
                    ['🌋', 'Etna Nord – accesso', '20 min'],
                    ['🚂', 'Stazione Mascali', '5 min'],
                    ['🛒', 'Centro commerciale', '8 min'],
                ];
...
<section class="final-cta">
    ...
    <div class="final-cta__inner">
        <span class="final-cta__eyebrow" data-reveal="fade">Prenotazione diretta</span>
        <h2 class="final-cta__headline" data-reveal="up" data-delay="100">
            La tua vacanza<br><em>siciliana perfetta</em><br>ti aspetta
        </h2>
        <p class="final-cta__text" data-reveal="up" data-delay="200">
            Prenota direttamente e ottieni il miglior prezzo garantito,
            cancellazione flessibile e un benvenuto speciale.
        </p>
        ...
        <div class="final-cta__actions" data-reveal="up" data-delay="300">
            ...
            <a href="tel:<?php echo esc_attr($host_phone); ?>" class="final-cta__tel">
                ...
                O chiamaci: <?php echo esc_html($host_phone); ?>
            </a>
            <?php endif; ?>
        </div>
