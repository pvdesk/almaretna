...
'it' => [
    ...
    'exp.quote'       => '"Qui il tempo non si misura in ore,<br>ma in profumi d\'ulivo, in tramonti sulla costa siciliana<br>e in silenzi che non dimenticherai mai."',
    ...
    'story.text1'     => "Almaretna è una villa di charme immersa nell'uliveto alle pendici dell'Etna, nel suggestivo borgo di Nunziata di Mascali. Qui il tempo rallenta, i profumi di zagara riempiono l'aria e la vista panoramica sulla costa est della Sicilia — da Taormina fino a Siracusa — regala tramonti indimenticabili. Su richiesta organizziamo escursioni verso le mete più belle dell'isola.",
    ...
    'pool.desc'       => "La piscina di Almaretna è uno spazio pensato per il vero relax: <strong>15 metri per 6 di larghezza</strong>, con una profondità che arriva fino a <strong>3,5 metri</strong>. Immersa nel silenzio dell'uliveto con vista sull'Etna, è il luogo perfetto per una nuotata rigenerante o per oziare al sole.",
    ...
    'num.sunsets'     => "Tramonti sulla costa",
    'num.sea'         => 'Dal mare',
    ...
    'foot.back_home'  => '← Torna alla home',
...
'en' => [
    ...
    'exp.quote'       => '"Here time is not measured in hours,<br>but in the scent of olive trees, in sunsets over the Sicilian coast,<br>and in silences you will never forget."',
    ...
    'story.text1'     => "Almaretna is a charming villa nestled in the olive grove on the slopes of Etna, in the picturesque village of Nunziata di Mascali. Here time slows down, the scent of orange blossom fills the air and the panoramic view of Sicily's east coast — from Taormina to Syracuse — gifts unforgettable sunsets. On request, we organise excursions to the most beautiful destinations on the island.",
    ...
    'pool.desc'       => "Almaretna's pool is a space designed for true relaxation: <strong>15 metres long and 6 metres wide</strong>, with a depth of up to <strong>3.5 metres</strong>. Nestled in the silence of the olive grove with views of Etna, it is the perfect place for a refreshing swim or to lounge in the sun.",
...
'de' => [
    ...
    'exp.quote'       => '"Hier misst man die Zeit nicht in Stunden,<br>sondern im Duft der Olivenbäume, in Sonnenuntergängen über der sizilianischen Küste<br>und in Stille, die man nie vergisst."',
    ...
    'story.text1'     => "Almaretna ist eine charmante Villa inmitten eines Olivenhains am Fuße des Ätna, im malerischen Dorf Nunziata di Mascali. Hier verlangsamt sich die Zeit, der Duft von Orangenblüten erfüllt die Luft und der Panoramablick auf Siziliens Ostküste — von Taormina bis Syrakus — beschert unvergessliche Sonnenuntergänge. Auf Anfrage organisieren wir Ausflüge zu den schönsten Zielen der Insel.",
    ...
    'num.sunsets'     => 'Küsten-Sonnenuntergänge',
    'num.sea'         => 'Vom Meer',
    ...
    'foot.back_home'  => '← Zurück zur Startseite',
...
'fr' => [
    ...
    'exp.quote'       => '"Ici, le temps ne se mesure pas en heures,<br>mais en parfums d\'olivier, en couchers de soleil sur la côte sicilienne<br>et en silences que vous n\'oublierez jamais."',
    ...
    'story.text1'     => "Almaretna est une villa de charme nichée dans l'oliveraie sur les pentes de l'Etna, dans le pittoresque village de Nunziata di Mascali. Ici le temps ralentit, les parfums de fleurs d'oranger emplissent l'air et la vue panoramique sur la côte est de la Sicile — de Taormine jusqu'à Syracuse — offre des couchers de soleil inoubliables. Sur demande, nous organisons des excursions vers les plus beaux sites de l'île.",
    ...
    'pool.desc'       => "La piscine d'Almaretna est un espace conçu pour la vraie détente : <strong>15 mètres de long et 6 mètres de large</strong>, avec une profondeur allant jusqu'à <strong>3,5 mètres</strong>. Nichée dans le silence de l'oliveraie avec vue sur l'Etna, c'est l'endroit idéal pour une baignade revitalisante ou pour se prélasser au soleil.",
    ...
    'num.sunsets'     => "Couchers de soleil sur la côte",
    'num.sea'         => 'De la mer',
    ...
    'foot.back_home'  => '← Retour à l\'accueil',
...
'es' => [
    ...
    'exp.quote'       => '"Aquí el tiempo no se mide en horas,<br>sino en aromas de olivo, en atardeceres sobre la costa siciliana<br>y en silencios que nunca olvidarás."',
    ...
    'story.text1'     => "Almaretna es una villa de encanto inmersa en el olivar en las faldas del Etna, en el pintoresco pueblo de Nunziata di Mascali. Aquí el tiempo se ralentiza, los aromas de azahar llenan el aire y la vista panorámica de la costa este de Sicilia — desde Taormina hasta Siracusa — regala atardeceres inolvidables. A petición, organizamos excursiones a los destinos más bellos de la isla.",
    ...
    'pool.desc'       => "La piscina de Almaretna es un espacio pensado para el verdadero relax: <strong>15 metros de largo y 6 de ancho</strong>, con una profundidad de hasta <strong>3,5 metros</strong>. Inmersa en el silencio del olivar con vistas al Etna, es el lugar perfecto para un refrescante baño o para descansar al sol.",
    ...
    'num.sunsets'     => 'Atardeceres sobre la costa',
    'num.sea'         => 'Del mar',
    ...
    'foot.back_home'  => '← Volver al inicio',
...
function alm_i18n_pills(): array {
    $lang = alm_get_lang();
    $data = [
        'it' => [['🌋','Vista Etna'],['🫒','Uliveto'],['🏊','Piscina panoramica'],['🌊','10 min dal mare'],['🌅','Tramonti sulla costa'],['📶','Wi-Fi gratuito'],['🌿','Aria pulita di montagna'],['⭐','Ospitalità siciliana autentica']],
        'en' => [['🌋','Etna view'],['🫒','Olive grove'],['🏊','Panoramic pool'],['🌊','10 min from the sea'],['🌅','Sunsets over the coast'],['📶','Free Wi-Fi'],['🌿','Clean mountain air'],['⭐','Authentic Sicilian hospitality']],
        'de' => [['🌋','Ätna-Blick'],['🫒','Olivenhain'],['🏊','Panoramabecken'],['🌊','10 Min. vom Meer'],['🌅','Sonnenuntergänge über der Küste'],['📶','Kostenloses WLAN'],['🌿','Klare Bergluft'],['⭐','Echte sizilianische Gastfreundschaft']],
        'fr' => [['🌋',"Vue sur l'Etna"],['🫒','Oliveraie'],['🏊','Piscine panoramique'],['🌊','10 min de la mer'],['🌅','Couchers de soleil sur la côte'],['📶','Wi-Fi gratuit'],['🌿','Air pur de montagne'],['⭐','Hospitalité sicilienne authentique']],
        'es' => [['🌋','Vista del Etna'],['🫒','Olivar'],['🏊','Piscina panorámica'],['🌊','10 min del mar'],['🌅','Atardeceres sobre la costa'],['📶','Wi-Fi gratuito'],['🌿','Aire limpio de montaña'],['⭐','Hospitalidad siciliana auténtica']],
    ];
    return $data[$lang] ?? $data['it'];
}
...
function alm_i18n_numbers(): array {
    ...
    $data = [
        'it' => [[$room_count,'Camere esclusive'],['∞',"Tramonti sulla costa"],["10'",'Dal mare'],['★ 4.9','Valutazione media']],
        'en' => [[$room_count,'Exclusive rooms'],['∞','Coastal sunsets'],["10'",'From the sea'],['★ 4.9','Average rating']],
        'de' => [[$room_count,'Exklusive Zimmer'],['∞','Küsten-Sonnenuntergänge'],["10'",'Vom Meer'],['★ 4.9','Durchschnittsbewertung']],
        'fr' => [[$room_count,'Chambres exclusives'],['∞',"Couchers de soleil sur la côte"],["10'",'De la mer'],['★ 4.9','Note moyenne']],
        'es' => [[$room_count,'Habitaciones exclusivas'],['∞','Atardeceres sobre la costa'],["10'",'Del mar'],['★ 4.9','Valoración media']],
    ];
    return $data[$lang] ?? $data['it'];
}
